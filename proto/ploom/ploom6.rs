        ...
        for p2 in &model.plooms {
            ...
            if  distance < MIN_DISTANCE{
                draw.line()
                    ...
                    .end(p2.focus)
                    .weight(2.0)
                    .rgba(0.55294118, 0.88627451, 0.89019608, time/500.0);
            }
            ...
            if  MIN_DISTANCE < distance && distance < MAX_DISTANCE {
                draw.line()
                    ...
                    .end(p2.focus)
                    .weight(2.0)
                    .rgba(0.04, 0.56, 0.99, time/500.0);
